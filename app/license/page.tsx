      ...
      <div className="max-w-md w-full space-y-8">
        <body>
          ...
          <p>
            ...
            intransferible y de uso limitado para el uso del software con el
            único propósito de gestionar las prácticas profesionales. El
            software no puede ser utilizado para fines distintos a los
            establecidos sin el consentimiento explícito del desarrollador.
          </p>
          ...
          <p>
            ...
            imposibilidad de usar el software, incluyendo, pero no limitado a,
            la pérdida de datos, interrupciones del servicio o cualquier otra
            situación derivada del uso del software.
          </p>

          <h2>4. Uso de Datos Personales</h2>
          <p>
            El desarrollador no tiene acceso a los datos personales almacenados
            a través del uso del software. Dichos datos son gestionados por
            Leonel Silva Gonzalez y son responsabilidad exclusiva de sus
            administradores. El desarrollador no se hace responsable del mal uso
            o violación de la información almacenada en el sistema.
          </p>
          ...
          <p>
            ...
            brechas de seguridad o accesos no autorizados a los datos
            almacenados.
          </p>
          ...
          <p>
            ...
            mejoras al software sin previo aviso, pero no tiene obligación
            alguna de mantener o actualizar el software una vez entregado a
            Leonel Silva Gonzalez.
          </p>
